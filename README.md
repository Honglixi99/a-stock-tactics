...
> **当前版本 v1.6.1** ·「技术打分 + 基本面避雷 + 人工规则提示」体检 +「低吸选股」+「资金博弈四态/连板语义/解禁压力/ROE质量」+「**五档评级 + 多空对辩 + T+1陷阱**」（吸收自 TradingAgents 全套分析框架）。
...
- **妖股顶部识别**：近10日涨停≥3次 / 20日涨≥50% / 天量≥4倍 / 三板以上 → 把"爆炒亏损股"从买入候选里降级为"高风险观望"
